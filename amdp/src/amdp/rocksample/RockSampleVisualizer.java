...
public class RockSampleVisualizer {
    ...
    private RockSampleVisualizer(){
        initializeColours();
//
//        darkerColourMap.put(RockSampleDomain.DARKGREY, Color.darkGray.darker());
//        darkerColourMap.put(RockSampleDomain.RED, Color.red.darker());
//        darkerColourMap.put(RockSampleDomain.GREEN, Color.green.darker());
//        darkerColourMap.put(RockSampleDomain.BLUE, Color.blue);
//        darkerColourMap.put(RockSampleDomain.YELLOW, Color.yellow);
//        darkerColourMap.put(RockSampleDomain.MAGENTA, Color.magenta);
//        darkerColourMap.put(RockSampleDomain.PINK, Color.pink);
//        darkerColourMap.put(RockSampleDomain.ORANGE, Color.orange);
//        darkerColourMap.put(RockSampleDomain.CYAN, Color.cyan);
    ...
    private void initializeColours(){
        colourMap.put(RockSampleDomain.DARKGREY, Color.darkGray);
        colourMap.put(RockSampleDomain.RED, Color.red);
        colourMap.put(RockSampleDomain.GREEN, Color.green);
        colourMap.put(RockSampleDomain.BLUE, Color.blue);
        colourMap.put(RockSampleDomain.YELLOW, Color.yellow);
        colourMap.put(RockSampleDomain.MAGENTA, Color.magenta);
        colourMap.put(RockSampleDomain.PINK, Color.pink);
        colourMap.put(RockSampleDomain.ORANGE, Color.orange);
        colourMap.put(RockSampleDomain.CYAN, Color.cyan);
    }
    ...
    public static StateRenderLayer getStateRenderLayer(int w, int h){
        ...
        oopainter.addObjectClassPainter(RockSampleDomain.LOCATIONCLASS, new LocationPainter(w, h, 0, true));
        oopainter.addObjectClassPainter(RockSampleDomain.TAXICLASS, new CellPainter(1, Color.gray, w, h));
        oopainter.addObjectClassPainter(RockSampleDomain.PASSENGERCLASS, new PassengerPainter(w, h, 1, false));
        oopainter.addObjectClassPainter(RockSampleDomain.WALLCLASS, new WallPainter(w, h));
    ...
    public static class CellPainter implements ObjectPainter {
        ...
        public void paintObject(Graphics2D g2, OOState s, ObjectInstance ob, float cWidth, float cHeight) {
            ...
            float rx = ((RoverAgent)ob).x*width;
            float ry = cHeight - height - ((RoverAgent)ob).y*height;
...
//            }
    ...
    public static class PassengerPainter implements ObjectPainter{
        ...
        public void paintObject(Graphics2D g2, OOState s, ObjectInstance ob, float cWidth, float cHeight) {
            ...
            String goalLocation = ((TaxiPassenger)ob).goalLocation;//getIntValForAttribute(RockSampleDomain.GOALLOCATIONATT);
            int type = ((RockSampleState)s).locationIndWithColour(goalLocation);
...
//            this.vertical = vertical;
        ...
        public void paintObject(Graphics2D g2, OOState s, ObjectInstance ob,
            ...
            int wp = ((RockSampleMapWall)ob).wallOffset;
            int e1 = ((RockSampleMapWall)ob).wallMin;
            int e2 = ((RockSampleMapWall)ob).wallMax;
            boolean vertical  =((RockSampleMapWall)ob).verticalWall;

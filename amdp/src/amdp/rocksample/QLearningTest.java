 ...
 *
 */
public class QLearningTest extends MDPSolver implements QProvider, LearningAgent, Planner{
     ...
     */
    public QLearningTest(SADomain domain, double gamma, HashableStateFactory hashingFactory,

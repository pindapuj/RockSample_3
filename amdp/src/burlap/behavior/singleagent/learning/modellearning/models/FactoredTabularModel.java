 ...
 *
 */
public class FactoredTabularModel extends TabularModel{
...
//    protected int								nConfident;
     ...
     */
    public FactoredTabularModel(SADomain sourceDomain, HashableStateFactory hashingFactory, int nConfident){
        super(sourceDomain, hashingFactory, nConfident);
    }


    public FactoredTabularModel(SADomain sourceDomain, HashableStateFactory hashingFactory, int nConfident, Map<HashableState, StateNode> stateNodes,
                                Set<HashableState> terminalStates){
        super(sourceDomain, hashingFactory, nConfident);
    ...
    public SADomain getSourceDomain() {
        return sourceDomain;
    }

    public void setSourceDomain(SADomain sourceDomain) {
    ...
    public int getnConfident() {
        return nConfident;
    }

    public void setnConfident(int nConfident) {
        this.nConfident = nConfident;
    }
// getters and setters for terminal states and state Nodes

    public Map<HashableState, StateNode> getStateNodes() {
        return stateNodes;
    }

    public void setStateNodes(Map<HashableState, StateNode> stateNodes) {
        this.stateNodes = stateNodes;
    }

    public Set<HashableState> getTerminalStates() {
        return terminalStates;
    }

    public void setTerminalStates(Set<HashableState> terminalStates) {
        this.terminalStates = terminalStates;
    }
